const SkeletonCard = () => {
  return (
    <div
      role='status'
      className='border-gray-200 shadow animate-pulse dark:border-gray-500 rounded-xl w-72 h-[22rem] self-start'
    >
      ...
      <div className='w-11/12 flex flex-col gap-4'>
        <div className='flex flex-row justify-between'>
          <div className='flex flex-row gap-2'>
            <div className='h-6 bg-gray-200 rounded-md dark:bg-gray-700 w-6 mb-4'></div>
            <div className='h-6 bg-gray-200 rounded-md dark:bg-gray-700 w-6 mb-4'></div>
            <div className='h-6 bg-gray-200 rounded-md dark:bg-gray-700 w-6 mb-4'></div>
          </div>
          <div className='h-6 bg-gray-200 rounded-md dark:bg-gray-700 w-6 mb-4'></div>
